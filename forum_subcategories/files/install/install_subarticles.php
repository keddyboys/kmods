...
if (iADMIN && (iUSER_RIGHTS != "" || iUSER_RIGHTS != "C")) {
		...
		if (dbrows($result) == 0) {
		        echo "<div style='text-align:center'>".$locale['sa_102'];
                echo "<br /><br /><center>
		        ...
		        echo "<br /><div style='text-align:center'>".$locale['sa_103'];
                echo "<br /><br /><center>
                <form name='subforums' method='post' action='".FUSION_SELF."'>
		...
		closetable();
            ...
            echo "<div style='text-align:center'><a href='".BASEDIR."install/index.php'>".$locale['install_11']."</a></div>";
            closetable();
        }
