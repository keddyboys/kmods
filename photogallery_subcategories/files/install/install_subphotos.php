...
if (iADMIN && (iUSER_RIGHTS != "" || iUSER_RIGHTS != "C")) {
		...
		$result = dbquery("SHOW COLUMNS FROM ".DB_PHOTO_ALBUMS." LIKE 'album_parent'");
		if (dbrows($result) == 0) {
		        echo "<div style='text-align:center'>".$locale['install_102'];
                echo "<br /><br /><center>
                <form name='subphotos' method='post' action='".FUSION_SELF."'>
		...
		closetable();
            ...
            if (isset($_POST['action']) && $_POST['action'] == "install") {
				...
				// Alter table
		        $result = dbquery("ALTER TABLE ".DB_PHOTO_ALBUMS." ADD album_parent MEDIUMINT( 8 ) UNSIGNED NOT NULL DEFAULT '0' AFTER album_user");
			...
			if (isset($_POST['action']) && $_POST['action'] == "delete") {
				...
				// Alter table
		        $result = dbquery("ALTER TABLE ".DB_PHOTO_ALBUMS." DROP album_parent");
